...
public class ClimbingClub
{
   ...
   {
       ClimbInfo climber = new ClimbInfo(peakName, climbTime);
       int index = 0;
    
       while(climbList.size() > index && climbList.get(index).getName().compareTo(peakName)<0) {
            index++;
       }
       climbList.add(index,climber);
